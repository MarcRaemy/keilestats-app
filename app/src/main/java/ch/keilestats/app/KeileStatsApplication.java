...
import ch.keilestats.app.entities.Game;
import ch.keilestats.app.entities.Goal;
import ch.keilestats.app.entities.Opponent;
import ch.keilestats.app.entities.Player;
import ch.keilestats.app.repositories.GameRepository;
import ch.keilestats.app.repositories.GoalRepository;
import ch.keilestats.app.repositories.OpponentRepository;
import ch.keilestats.app.repositories.PlayerRepository;
 ...
 * application components. -The ability to load file resources in a generic
 * fashion. Inherited from the ResourceLoader interface. -The ability to publish
 * events to registered listeners. Inherited from the ApplicationEventPublisher
 * interface. -The ability to resolve messages, supporting internationalization.
 * Inherited from the MessageSource interface. -Inheritance from a parent
 * context. Definitions in a descendant context will always take priority. This
 * means, for example, that a single parent context can be used by an entire web
 * application, while each servlet has its own child context that is independent
 * of that of any other servlet.
 * 
 * In addition to standard BeanFactory lifecycle capabilities,
 * ApplicationContext implementations detect and invoke ApplicationContextAware
 * beans as well as ResourceLoaderAware, ApplicationEventPublisherAware and
 * MessageSourceAware beans. A6-[6Eun
 */
